\section*{Submission Declarations Draft}
...
\begin{itemize}
\item \path{data/processed/bootstrap/discrepancies/field_discrepancy_stats.json}
\item \path{data/processed/bootstrap/discrepancies/nvd_ghsa_field_views.jsonl}
\item \path{results/paper_cose/cose_artifact_tables.md}
\item \path{results/paper_cose/cose_case_studies.md}
\item \path{data/annotations/rq2/discrepancy_typing_seed.jsonl}
\item \path{data/annotations/rq3/silver_v2/}
